...
public class TestHarness {
	...
	public void printIntersects() {
		...
		System.out.println("Printing Intersects");
		while (iter.hasNext()) {
			MeetingContactIntersect thisIntersect=iter.next();
			System.out.print("Date="+DateUtilities.formatDate(thisIntersect.getDate()));
			System.out.print(", Meeting Id="+thisIntersect.getMeeting().getId());
			System.out.print(", type="+thisIntersect.getMeeting().getClass().getName());
			System.out.print(", Contact Id="+thisIntersect.getContact().getId());
			System.out.print(", Contact Name="+thisIntersect.getContact().getName());
			System.out.println();
		}		
	}
	...
	public void createMeetings() {
		...
		insertIntersect(myCalendar, myMeeting, contacts);
		...
		insertIntersect(c1, myMeeting, contacts);
		this.latestMeetingId++;
		//System.out.println(myMeeting.getId() + ":" + DateUtilities.formatDate(myMeeting.getDate()) );
		meetings.add(myMeeting);
	}
